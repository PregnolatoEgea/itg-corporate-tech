...
<div id="page" class="site">
      ...
      <div class="itgPreHeader__leftSide">
        <?php
          ...
          foreach ($left_menu as $key => $left_menu_item) {
            ...
            ?>
              <a target="<?php echo $left_menu_item_target; ?>" href="<?php echo $left_menu_item_url; ?>" class="itgPreHeader--singleItem itg-mr-16"><?php echo $left_menu_item_title; ?></a>
            <?php
          }
        ?>
      </div>
    ...
    <div class="itgHeader itg-px-56 itg-py-32">
      ...
      <div class="itgHeader__rightSide">
        ...
        <div class="itgMainMenu__container itg-px-32 itg-py-8 is-hide">
        <?php
          $main_menu = wp_get_nav_menu_items('main-menu');
          ...
          foreach ($main_menu as $key => $main_menu_item) {
            ...
            if(get_field('is_tab_start', $main_menu_item_ID)){
              ?>
                <div class="itgMainMenu__container--single itg-mt-16">
              <?php
            }

            if($main_menu_item_parent === '0' && get_field('is_tab_start', $main_menu_item_ID) === false && get_field('is_tab_end', $main_menu_item_ID) === false){
              ?>
                <a target="<?php echo $main_menu_item_target; ?>" href="<?php echo $main_menu_item_url; ?>" class="itgMainMenu__container--primary itg-pb-16 itg-mb-16">
                  <?php
                    echo $main_menu_item_title;
                  ?>
                </a>
              <?php
            }elseif($main_menu_item_parent !== '0' && get_field('is_tab_start', $main_menu_item_ID) === false && get_field('is_tab_end', $main_menu_item_ID) === false){
              ?>
                <a target="<?php echo $main_menu_item_target; ?>" href="<?php echo $main_menu_item_url; ?>" class="itgMainMenu__container--secondary <?php if(get_field('is_mobile_only', $main_menu_item_ID)){echo 'is-mobile-only'; } ?> itg-mb-16">
                  <?php
                    echo $main_menu_item_title;
                  ?>
                </a>
            ...
            if(get_field('is_tab_end', $main_menu_item_ID)){
              ?>
                </div>
              <?php
            }

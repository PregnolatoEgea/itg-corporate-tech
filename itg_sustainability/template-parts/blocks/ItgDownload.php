...
?>
<div id="itg_block_<?php echo $block_id; ?>" class="itgBlock-download <?php echo $enviroment; ?>">
  <div class="container">
    <div class="columns <?= $is_centered ?>">
      <div class="column <?= $class_colum ?> <?= $offset ?>">
        <div class="itgBlock-download__title h5">
          <?php echo $title ?>
        </div>
      </div>
    </div>
          ...
          while ( have_rows("colonna_files") ) : the_row();  ?>
            ...
            if (have_rows('download')):
              ...
              while( have_rows('download') ) : the_row();
                ...
                $file_title = get_sub_field("nome_download") ? get_sub_field("nome_download") : get_the_title($file['ID']);
              ...
              ?>
              <div class="itgBlock-download__file itg-mb-24">
                <div class="itgBlock-download__file-icon-container">
                  <div class="itgBlock-download__file-icon-image <?php echo $fileImageColor; ?>"></div>
                </div>
                <div class="itgBlock-download__file-title itg-pl-32">
                  <a href="<?php echo $file_url; ?>">
                    <span class="itgBlock-download__file-title-1strow p2 <?php echo $fileNameColor; ?>">
                      <?php echo $file_title; ?><br>
                    </span>
                    <span class="itgBlock-download__file-title-2ndrow p1 <?php echo $fileSizeColor; ?>">

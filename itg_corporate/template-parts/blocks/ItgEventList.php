          ...
          <div id="event-card-<?php echo $eventListkey ?>" class="column is-12 itg-mb-48 itgBlock-ItgEventList__block <?php if(($eventObj["event_year"] != $currentYear) && $show_years_filter){ echo 'hidden' ;} ?>"
            ...
            >
              ...
              <div class="columns is-mobile itgBlock-ItgEventList__event--card is-hidden-touch"  >
                ...
                <div class="column is-2 itgBlock-ItgEventList__event--card--left-panel is-centered is-vcentered <?php if($eventObj["is_event_past"]){ echo 'expired' ;} ?>">
                  <div class="itgBlock-ItgEventList--icon-container">
                      <div class="itgBlock-ItgEventList--icon-image <?php echo $eventObj["event_icon"] ?> <?php if($eventObj["is_event_past"]){ echo 'expired' ;} ?>"></div>                                            
                  </div>
                  <div class="itgBlock-ItgEventList--left-labels-container">
                      <div class="itgBlock-ItgEventList--left-labels-list p1">                      
                        <div class="itgBlock-ItgEventList--left-labels-category is-uppercase <?php if($eventObj["is_event_past"]){ echo 'expired' ;} ?>"> <?php echo _e($eventObj["event_category"]) ?> </div>                       
                      </div>                                            
                  </div>                
                </div>
              ...
              <div class="columns is-mobile is-multiline itgBlock-ItgEventList__event--card is-hidden-desktop"  >    
                ...
                <div class="column is-12 itgBlock-ItgEventList__event--card--left-panel <?php if($eventObj["is_event_past"]){ echo 'expired' ;} ?>">
                    <div class="itgBlock-ItgEventList--icon-container">
                        <div class="itgBlock-ItgEventList--icon-image <?php echo $eventObj["event_icon"] ?> <?php if($eventObj["is_event_past"]){ echo 'expired' ;} ?>" style="float: left;"></div>                                            

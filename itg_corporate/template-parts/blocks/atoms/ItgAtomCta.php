...
?>
<div class="columns is-marginless <?php if ($is_centered) {
                                    echo $is_centered;
                                  } ?>">
  <a target="<?php echo $cta_link['target']; ?>" href="<?php echo $cta_link['url']; ?>" class="column itgAtom__ItgCTA p1 itg-px-32 itg-py-16 <?php if ($is_offset) {
                                                                                                                                                echo $is_offset;
                                                                                                                                              } ?>" style="color:<?php echo $cta_color; ?>; border-style:<?php if ($cta_border_style) {
                                                                                                                                                                                                            echo $cta_border_style;
                                                                                                                                                                                                          } ?>; border-color: <?php if ($cta_color) {
                                                                                                                                                                                                                                echo $cta_color;
                                                                                                                                                                                                                              } ?>">

        ...
        <div class="columns is-centered is-mobile">
          <div class="column is-8">
            <div class="itg__singlepost_share aligncenter itg-mt-40 itg--my-20 mb-0">
              ...
              <a href="https://twitter.com/share" target="_blank" class="twitter-share-button" data-url="<?php echo $url; ?>" data-via="italgas" data-text="<?php the_title(); ?>" data-related="Italgas" data-count="vertical">
...
?>
      ...
      <div style="<?php if ($section_wave_border && $wave_border_type === '') { ?> clip-path:url(#wave_<?php echo $section_id; ?>); margin-top: -70px; padding-top: 180px; <?php }
                                                                                                                                                                        if ($section_background_image) { ?> background-image:url(<?php echo $section_background_image['url']; ?>); <?php } ?>" class="ItgLayoutSection section<?php echo ($section_background_color) ? " itg--background-color-$section_background_color" : '';
                                                                                                                                                                                                                                                                                                                                      echo ($section_blob_effect) ? " hasBlobsContainer" : '';
                                                                                                                                                                                                                                                                                                                                      echo ($has_no_padding) ? " has-no-padding" : ''; ?>">
